...
function Page() {
  ...
  const onSubmit = async (data) => {
    const res = await axios.post(
      `${import.meta.env.VITE_BASE_API}/math/fixed_position`,
      {
        fn: data.fn,
        gn: data.gn,
        x0: data.x0,
      ...
      <div className="d-flex justify-content-center">
        <div className="col-sm-9">
          ...
          <div className="row justify-content-center">
            <h4 className="text-center mb-3">Fixed Position Method</h4>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="col-sm-6 mb-5">
              ...
              <div className="mb-3 row">
                <label className="col-sm-3 col-form-label">gn</label>
                <div className="col-sm-8">
                  <input
                    className="form-control"
                    type="text"
              ...
              <div className="mb-3 row">
                <label className="col-sm-3 col-form-label">x</label>
                <div className="col-sm-8">
                  <input
                    className="form-control"
                    type="text"
...
function onBeforeRender() {
  const documentProps = {
    ...
    description: "Fixed Position Page",
  };
  return {
    pageContext: {
      documentProps,
